...
ALLOWED_HOSTS = ['*']  # Allow any host (for development 
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000','http://13.202.221.203:3000', 'http://ec2-13-202-221-203.ap-south-1.compute.amazonaws.com:3000' # Your frontend origin
